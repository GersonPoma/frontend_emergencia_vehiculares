...
import { GestionarPrivilegiosComponent } from './gestionar-privilegios/gestionar-privilegios';
...
export class RolComponent implements OnInit, OnDestroy {
  ...
  gestionarPrivilegios(rol: Rol): void {
    this.dialog.open(GestionarPrivilegiosComponent, {
      width: '500px',
      maxWidth: '90vw',
      data: { rol }
    });
